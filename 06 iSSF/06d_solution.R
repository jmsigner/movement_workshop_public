...
# 6. What is the log-RSS for a step ending at different elevations. Choose a suiteable range of elevations.
...
ggplot(logrss$df, aes(x = elevation_x2, y = exp(log_rss))) + geom_line()
