...
# LaPoint and has benn widely used for many methodological comparisons, examples
...
# often a bit easiert to memorize.
...
# We should verify though, that the time zone is set correctly. We can do this with the function `tz()`. 
tz(dat1$t_)
